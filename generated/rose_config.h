...
#define CXX_INCLUDE_STRING {"g++_HEADERS" , "g++_HEADERS/compiler_macro_hdrs", "g++_HEADERS/hdrs", "g++_HEADERS/hdrs1", "g++_HEADERS/hdrs2", "/usr/lib/gcc/x86_64-redhat-linux/8/../../../../include/c++/8", "/usr/lib/gcc/x86_64-redhat-linux/8/../../../../include/c++/8/x86_64-redhat-linux", "/usr/lib/gcc/x86_64-redhat-linux/8/../../../../include/c++/8/backward", "/usr/lib/gcc/x86_64-redhat-linux/8/include", "/usr/local/include", "/usr/include"}

/* Include path for backend C compiler. */
#define C_INCLUDE_STRING {"gcc_HEADERS" , "gcc_HEADERS/compiler_macro_hdrs", "gcc_HEADERS/hdrs", "/usr/lib/gcc/x86_64-redhat-linux/8/include", "/usr/local/include", "/usr/include"}
